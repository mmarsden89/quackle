    ...
    return (
      <div className="upload-container">
        <form id="create" encType="multipart/form-data" onSubmit={this.onCreatePicture} className="upload-container">
          <input className="upload-input" required type="hidden" value="Video" name="description" placeholder="description" onChange={this.handleChange} maxLength="160"/>
          <input className="upload-input" required type="hidden" value="Video" name="tag" placeholder="#Tag" onChange={this.handleChange}/>
